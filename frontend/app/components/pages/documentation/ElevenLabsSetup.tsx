    ...
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mx-auto mb-20 max-w-3xl text-center">
          ...
          >
            Bulk Audio Generator supports both ElevenLabs and Google AI Studio
            Text-to-Speech. Choose your preferred provider and follow the steps
            below to get your API key. Your key stays inside your browser and is
            ...
            <div className="flex-1 w-full">
              ...
              <div className="space-y-6">
                {steps.map((step, index) => (
                  <Card
                    key={step.title}
                    className="overflow-hidden rounded-2xl border border-primary/5 bg-white/70 shadow-sm backdrop-blur-sm transition-all duration-300 hover:shadow-md hover:shadow-primary/5 hover:border-primary/10"
                  >
            ...
            <div className="flex-1 w-full">
              ...
              <div className="space-y-6">
                {googleSteps.map((step, index) => (
                  <Card
                    key={step.title}
                    className="overflow-hidden rounded-2xl border border-secondary/5 bg-white/70 shadow-sm backdrop-blur-sm transition-all duration-300 hover:shadow-md hover:shadow-secondary/5 hover:border-secondary/10"
                  >
                    <CardContent className="p-0">
                      <div className="flex flex-col lg:flex-row">
                        <div className="flex flex-1 flex-col justify-center p-6 lg:p-8">
          ...
          <Card className="rounded-2xl border border-primary/10 bg-white/60 shadow-sm backdrop-blur-sm">
            <CardContent className="flex flex-col sm:flex-row gap-5 p-8 items-start">
              ...
              <div className="flex-1">
                ...
                <Paragraph className="mt-2 text-on-surface-variant/80 leading-relaxed">
                  Your API key is transmitted securely to our backend, encrypted
                  using industry‑standard Fernet (symmetric encryption), and
                  stored in the database. The raw key is never persisted in your
                  browser or accessible to anyone. Whether you choose ElevenLabs
                  or Google AI Studio, your credentials remain protected at all
                  times.
                </Paragraph>
              </div>
            </CardContent>
