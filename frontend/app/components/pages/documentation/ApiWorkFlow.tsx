...
const WORKFLOW_STEPS = [
  ...
  },
  {
    ...
    description: "Validates the input, prepares the request and sends it securely to the backend.",
  },
  {
    icon: ServerCog,
  ...
  },
  {
    ...
    title: "ZIP Download",
    color: "bg-primary-fixed text-primary",
    description: "All generated MP3 files are compressed into a ZIP archive and downloaded instantly.",
  },
] as const;

export const ApiWorkflowSection = memo(() => {
  return (
...
ApiWorkflowSection.displayName = "ApiWorkflowSection";