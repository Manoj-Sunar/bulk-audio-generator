        ...
        <div className="space-y-16">
          {steps.map((step, index) => {
            ...
            return (
              <Card
                key={step.title}
                className="overflow-hidden rounded-3xl border-outline-variant shadow-sm transition-all duration-300 hover:shadow-xl"
              >
                    ...
                    <div className="flex flex-1 flex-col justify-center p-8 lg:p-12">
                        ...
                        <div className="mt-6 rounded-2xl bg-primary-fixed p-4">
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              >
                                Choose between ElevenLabs (premium voice
                                quality) or Google AI Studio (great for
                      ...
                      {index === 5 && (
                        <div className="mt-6 flex flex-wrap gap-3">
                          <Button
                            size="sm"
                            rightIcon={<FolderArchive size={16} />}
                          >
                            Download ZIP
                          </Button>
                          <Button
                ...
                <div className="mt-8 grid gap-6 text-left md:grid-cols-2">
                  <div className="rounded-2xl bg-white/50 p-6">
                    ...
                    <Paragraph className="mt-2 text-on-surface-variant">
                      Select ElevenLabs for premium voice quality or Google AI
                      Studio for multilingual support.
                    </Paragraph>
                  </div>
                  ...
                  <div className="rounded-2xl bg-white/50 p-6">
                    ...
                    <Paragraph className="mt-2 text-on-surface-variant">
                      Use a blank line between each script to generate separate
                      audio files.
                    </Paragraph>
                  </div>
                  ...
                  <div className="rounded-2xl bg-white/50 p-6">
                    ...
                    <Paragraph className="mt-2 text-on-surface-variant">
                      ElevenLabs keys start with "sk_". Google AI Studio keys
                  ...
                  <div className="rounded-2xl bg-white/50 p-6">
                    ...
                    <Paragraph className="mt-2 text-on-surface-variant">
                      All generated files are available for download as a single
                      ZIP archive.
                    </Paragraph>
                  </div>
                </div>
