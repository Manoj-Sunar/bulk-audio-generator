...
const variants = {
    ...
    secondary:
        "bg-secondary text-on-secondary hover:opacity-90 focus-visible:ring-secondary",

    outline:
        "border border-outline bg-transparent text-on-surface hover:bg-surface-container focus-visible:ring-outline",
